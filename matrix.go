...
func (g Geom) Mul(b Geom) (c Geom) {
	c[0][0] = g[0][0]*b[0][0] + g[0][1]*b[1][0] // + 0
	c[0][1] = g[0][0]*b[0][1] + g[0][1]*b[1][1]

	c[1][0] = g[1][0]*b[0][0] + g[1][1]*b[1][0]
	c[1][1] = g[1][0]*b[0][1] + g[1][1]*b[1][1]

	c[2][0] = g[2][0]*b[0][0] + g[2][1]*b[1][0] + b[2][0] // * 1
	c[2][1] = g[2][0]*b[0][1] + g[2][1]*b[1][1] + b[2][1]
	return c
}
